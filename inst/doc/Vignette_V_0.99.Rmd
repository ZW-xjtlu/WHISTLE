---
title: "The *WHISTLE* user's guide"
author: |
...
graphics: yes
vignette: >
  %\VignetteIndexEntry{The WHISTLE user's guide}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignettePackage{WHISTLE}
...
knitr::opts_chunk$set(dev="png",fig.show="hold",
               ...
               message=FALSE,collapse=TRUE,size = "tiny")
set.seed(1)
```
...
## Introduction
The ***WHISTLE*** R-package has been developed
...
- ***Sequence Features***
The sequence derived features that are related to epitranscriptomics, such as the sequence motifs, predicted RNA secondary structures, and GC contents.
...
# The clustering on the input modification Granges.
   annot_clustering = mod_gr
)

str(feature_hg19_complete) #Complete feature set for epitranscriptomic modifications
```
